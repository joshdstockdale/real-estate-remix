...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create real-estate-remix-ae5a
  fly apps create real-estate-remix-ae5a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app real-estate-remix-ae5a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app real-estate-remix-ae5a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'real-estate-remix-ae5a-staging' does not match app name in config file 'real-estate-remix-ae5a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name real-estate-remix-ae5a-db
  fly postgres attach --app real-estate-remix-ae5a real-estate-remix-ae5a-db

  fly postgres create --name real-estate-remix-ae5a-staging-db
  fly postgres attach --app real-estate-remix-ae5a-staging real-estate-remix-ae5a-staging-db
  ```
